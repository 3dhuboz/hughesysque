...
const StorefrontHome = () => {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      {/* --- FULL-PAGE RISING EMBERS --- */}
      <div className="fixed inset-0 pointer-events-none z-[5] overflow-hidden">
        {[...Array(30)].map((_, i) => {
          const size = 1.5 + Math.random() * 3;
          const color = ['#ff4500', '#ff6a1a', '#ff8c42', '#ffad33', '#D9381E'][i % 5];
          const duration = 6 + Math.random() * 8;
          const anim = i % 2 === 0 ? 'emberFloat' : 'emberFloat2';
          return (
            <div
              key={`ember-${i}`}
              ...
              style={{
                ...
                animation: `${anim} ${duration}s ease-out infinite`,
      ...
      <section className="relative w-full overflow-hidden" style={{ minHeight: isLive ? '50vh' : '100vh' }}>
        ...
        {/* Subtle warm glow at bottom of hero */}
        <div className="absolute inset-0 pointer-events-none z-[1]">
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-[200px] bg-[radial-gradient(ellipse_at_bottom,_rgba(217,56,30,0.15)_0%,_transparent_70%)]" />
        </div>
