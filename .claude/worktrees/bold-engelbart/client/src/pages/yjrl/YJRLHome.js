...
const YJRLHome = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      api.get('/yjrl/stats/overview').catch(() => ({ data: null }))
        ...
        <div className="yjrl-hero-content">
          <div>
            ...
            <div className="yjrl-hero-actions">
              <Link to="/yjrl/register" className="yjrl-btn yjrl-btn-primary yjrl-btn-lg">
                Join the Club <ArrowRight size={18} />
              </Link>
              <Link to="/yjrl/fixtures" className="yjrl-btn yjrl-btn-secondary yjrl-btn-lg">
                View Fixtures
              </Link>
            </div>
          ...
          <div>
            {nextGame ? (
              <div style={{
                ...
                <Link to="/yjrl/fixtures" className="yjrl-btn yjrl-btn-secondary" style={{ marginTop: '1.5rem', width: '100%', justifyContent: 'center' }}>
              ...
              <div style={{
                ...
                <Link to="/yjrl/fixtures" className="yjrl-btn yjrl-btn-primary">View All Fixtures</Link>
              </div>
            )}
          </div>
        </div>
      ...
      {recentResults.length > 0 && (
        <div style={{ background: 'var(--yjrl-navy)', borderTop: '1px solid var(--yjrl-border)', borderBottom: '1px solid var(--yjrl-border)', padding: '0.875rem 0', overflow: 'hidden' }}>
          <div style={{ display: 'flex', gap: '3rem', padding: '0 1.5rem', overflowX: 'auto', maxWidth: 1280, margin: '0 auto', alignItems: 'center' }}>
            ...
            <Link to="/yjrl/fixtures" style={{ fontSize: '0.75rem', color: 'var(--yjrl-gold)', textDecoration: 'none', whiteSpace: 'nowrap', display: 'flex', alignItems: 'center', gap: '0.25rem', fontWeight: 600 }}>
      ...
      <section className="yjrl-section">
        <div className="yjrl-section-inner">
          ...
          <div style={{ textAlign: 'center', marginTop: '2rem' }}>
            <Link to="/yjrl/news" className="yjrl-btn yjrl-btn-secondary">
            ...
            {[
              {
                ...
                to: '/yjrl/portal/player', color: '#60a5fa', badge: 'Players'
              },
              {
                ...
                to: '/yjrl/portal/parent', color: '#c084fc', badge: 'Parents'
              },
              {
                ...
                to: '/yjrl/portal/coach', color: '#4ade80', badge: 'Coaches'
              },
              {
                ...
                to: '/yjrl/portal/admin', color: 'var(--yjrl-gold)', badge: 'Admin'
              },
            ].map((portal) => (
