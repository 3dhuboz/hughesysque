...
const ArticleDetail = ({ id }) => {
  ...
  if (!article) return (
    <div style={{ textAlign: 'center', padding: '5rem', color: 'var(--yjrl-muted)' }}>
      ...
      <Link to="/yjrl/news" className="yjrl-btn yjrl-btn-secondary" style={{ marginTop: '1rem' }}>Back to News</Link>
    </div>
  );

  return (
    <div style={{ maxWidth: 760, margin: '0 auto', padding: '2.5rem 1.5rem' }}>
      <Link to="/yjrl/news" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', color: 'var(--yjrl-muted)', textDecoration: 'none', fontSize: '0.875rem', marginBottom: '1.5rem', fontWeight: 500 }}>
  ...
  return (
    <YJRLLayout>
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '2rem 1.5rem' }}>
        ...
        {/* Featured article */}
        {featured && (
          <Link to={`/yjrl/news/${featured._id}`} style={{ textDecoration: 'none', display: 'block', marginBottom: '2rem' }}>
            <div style={{
