    ...
    <YJRLLayout>
      <div style={{ maxWidth: 600, margin: '0 auto', padding: '5rem 1.5rem', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
          <Link to="/yjrl" className="yjrl-btn yjrl-btn-primary">Back to Home</Link>
          <Link to="/yjrl/portal/parent" className="yjrl-btn yjrl-btn-secondary">Go to Parent Portal</Link>
        </div>
      </div>
    </YJRLLayout>
  );
    ...
    <YJRLLayout>
      ...
      <div style={{ background: 'linear-gradient(135deg, var(--yjrl-dark), var(--yjrl-navy))', padding: '3rem 1.5rem 2rem', borderBottom: '1px solid var(--yjrl-border)' }}>
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          <Link to="/yjrl" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', color: 'var(--yjrl-muted)', textDecoration: 'none', fontSize: '0.875rem', marginBottom: '1rem' }}>
