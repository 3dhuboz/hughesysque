...
export const INITIAL_SETTINGS: AppSettings = {
  ...
  businessAddress: 'Gladstone, QLD',
  tagline: 'Low & Slow BBQ',
  location: 'Gladstone, QLD',
  adminEmail: 'admin@hugheseysque.au',
  facebookUrl: 'https://www.facebook.com/Hugheseysbbq',
  instagramUrl: 'https://www.instagram.com/Hugheseysque',
  tiktokUrl: 'https://www.tiktok.com/@HugheseysQue',
  phone: '0480 502 444',
  contactEmail: 'hugheseysbbq2021@gmail.com',
  subtitle: 'Simple, affordable, memorable',
  heroHeading: 'Live in moments that matter',
  mapsUrl: 'https://www.google.com/maps/dir/?api=1&destination=Cnr+Breslin+St/And+Dawson+Highway+Gladstone+Central+QLD+4680',
  logoUrl: LOGO_URL,
  adminUsername: 'admin',
  adminPassword: '123',
  rewards: {
